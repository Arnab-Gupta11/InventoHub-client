          ...
          {features.map((feature, index) => {
            ...
            return (
              <div key={index} className={`rounded-2xl relative shadow-feature-card-shadow `} style={{ backgroundColor: color }}>
                <div
                  className={`w-14 h-14 bg-[#FED2C5] inline-flex justify-center items-center text-light-text-400 absolute -mt-5 left-5 rounded-2xl border-4 border-white dark:border-dark-bg-300`}
                >
