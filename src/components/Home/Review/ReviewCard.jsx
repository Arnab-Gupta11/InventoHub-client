...
const ReviewCard = ({ reviewCard }) => {
  const { name, photo, review } = reviewCard;
  const shadow = {
    boxShadow: "0px 0px 25px  #d3dce6",
  };
  return (
    <div
      className="relative flex  h-80  mt-5 ml-5 flex-col rounded-xl bg-white text-gray-700  px-5 py-5 "
      style={shadow}
      data-aos="flip-left"
    ...
    >
      <div className="relative mx-0 mt-4 flex items-center gap-4 overflow-hidden rounded-xl bg-transparent bg-clip-border pt-0 pb-8 text-gray-700 shadow-none">
        ...
        <div className="flex w-full flex-col gap-0.5">
          <div className="">
            <h5 className="block text-xl font-semibold leading-snug tracking-normal text-blue-gray-900 antialiased text-start">{name}</h5>
            <div className="5 flex items-center gap-0">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className="h-5 w-5 text-[#FF6A25]">
